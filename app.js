...
function applyV1040RoleSurface(){
 ...
 show('terrainBlackScreenBtn');show('coachingLayerControls');hide('observerTrackChoice');hide('leaveCoachingSession');if(!owner&&['waiting','live'].includes(s.status))show('leaveCoachingSession');

...
function applyV1040RoleSurface(){
 ...
 else if(v1040&&layingActor&&phase==='preparation'){setUiText('startLayingBtn','Démarrer la piste');show('startLayingBtn')}
 else if(v1040&&layingActor&&phase==='laying'){setUiText('trackReadyBtn','Terminer la piste');show('trackReadyBtn')}

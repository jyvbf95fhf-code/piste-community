...
async function requestCoachingPreviewLocation(){
 if(coachingPreviewWatch!==null&&!gpsWatchRegistry.has('coaching_preview'))coachingPreviewWatch=null;
...
function startCoachingPresence(){
 if(coachingPresenceWatch!==null&&!gpsWatchRegistry.has('coaching_presence'))coachingPresenceWatch=null;

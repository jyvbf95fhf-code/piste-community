...
async function startActiveCoaching(){
 ...
 const v1040=!!activeCoachingSession.phase||!!activeCoachingSession.laying_mode||!!activeCoachingSession.driver_started_at;
 if(v1040){
...
function coachingPhase(s){
  ...
  if(allowed.includes(s.phase))return s.phase;

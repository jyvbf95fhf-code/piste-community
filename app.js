...
function closeReplay3DPrototype(){replay3dUnsubscribe?.();replay3dUnsubscribe=null;replay3dPrototype?.destroy?.();replay3dPrototype=null;document.querySelector('.replay-3d-prototype')?.remove();document.querySelector('.replay-surface')?.classList.remove('hidden')}

...
async function renderCoachingMap(){
 ...
 const fullRoute=activeCoachingSession.planned_route||[],role=myCoachingRole(activeCoachingSession),route=role==='driver'&&activeCoachingSession.visibility_mode!=='all'?fullRoute.slice(0,1):fullRoute;

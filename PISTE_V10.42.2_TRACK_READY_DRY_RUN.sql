-- V10.42.2 DRY RUN : autorise live/laying -> waiting_ready.
-- Exécution manuelle uniquement après validation ; aucun changement persistant.
begin;
...
where routine_schema='public' and routine_name='mark_coaching_track_ready';
select has_function_privilege('authenticated','public.mark_coaching_track_ready(uuid)','EXECUTE') as authenticated_can_execute;

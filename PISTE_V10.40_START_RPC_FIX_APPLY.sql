-- V10.40 — Correctif de sécurité de la RPC historique de démarrage.
-- À exécuter manuellement uniquement après validation.
-- Les sessions legacy (workflow_version < 2) conservent leur contrat.
begin;
...
-- Vérifications post-transaction (lecture seule).

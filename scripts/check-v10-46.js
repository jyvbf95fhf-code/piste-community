...
assert(
  !changed.some(
    p=>p.endsWith('.sql')&&!['PISTE_V10.48_COACHING_MEMBER_SELF_LEAVE.sql','PISTE_V10.48_COACHING_MEMBER_SELF_LEAVE_DRY_RUN.sql','PISTE_V10.49_COACHING_ACTIVE_DEBRIEF.sql','PISTE_V10.49_COACHING_ACTIVE_DEBRIEF_VERIFY.sql','PISTE_V10.49.1B_COACHING_SOLO_JOIN.sql','PISTE_V10.49.1B_COACHING_SOLO_JOIN_VERIFY.sql','PISTE_V10.49.1C_COACHING_SOLO_TRANSITIONS.sql','PISTE_V10.49.1C_COACHING_SOLO_TRANSITIONS_VERIFY.sql'].includes(p) || p.startsWith('supabase/functions/')
  ),

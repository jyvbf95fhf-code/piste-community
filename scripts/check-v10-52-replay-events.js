...
(async () => {
  ...
  assert(!/maplibre|mapbox|cesium|satellite|relief/i.test(app.slice(app.indexOf('function replaySourceDataset'), app.indexOf('const REPORT_SECTION_ORDER'))), 'Bloc 5/3D must not enter event replay');

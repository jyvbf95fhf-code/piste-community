...
if(!/piste-community-v20(?:79|80|81|82)/.test(sw)||!/app\.js\?v=10(?:78|79|80|81)/.test(html+sw)||!/v2\.css\?v=20(?:62|63|64|65)/.test(html+sw))throw new Error('Cache V10.38.1+ incohérent.');

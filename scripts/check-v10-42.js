...
const checks=[
 ['version centralisée',/const APP_VERSION=['"]10\.42\.2['"]/.test(app)&&/APP_RELEASE_NOTES/.test(app)],
 ...
 ['cache PWA V10.42.2',/piste-community-v2100/.test(sw)&&/app\.js\?v=1042-12/.test(sw+html)&&/v2\.css\?v=2067/.test(sw+html)]
];

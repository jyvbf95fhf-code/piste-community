...
const checks=[
 ...
 ['âge Entraînement raccordé',/recordMode==='operational'\|\|recordMode==='training'\?operationalTrackAgeReference\(\)/.test(app)&&/recordMode==='operational'\|\|recordMode==='training'\?getOperationalTrackAgeMs\(\)/.test(app)],

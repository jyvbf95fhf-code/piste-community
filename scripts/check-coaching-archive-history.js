...
const opener=source('openLibraryItem');assert.match(opener,/coachingArchiveRouting/);assert.match(opener,/openCoachingHistoricalDebrief\(id\)/);assert.match(opener,/openCoachingSession\(id\)/);

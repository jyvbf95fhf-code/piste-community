...
const checks=[
 ...
 ['blind_mode envoyé',/p_blind_mode:/.test(app)],
 ['visibility_mode historique conservé',/'all','traceur'/.test(fs.readFileSync('PISTE_V10.42.3_PATCH/PISTE_V10.42.3_VISIBILITY_APPLY.sql','utf8'))],
 ['piste prête reliée',/trackReadyBtn/.test(html)&&/markCoachingTrackReady/.test(app)],
 ['conducteur attend la piste',/En attente de la piste|En attente : le Traceur prépare la piste/.test(app)],

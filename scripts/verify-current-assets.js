...
module.exports = function verifyCurrentAssets() {
  ...
  assert.match(sw, /^const C='piste-community-v2122';$/m);
  const assets = ['app.js?v=1047-3', 'v2.css?v=2083', 'v2.js?v=2022', 'styles.css?v=1027'];
...
if (require.main === module) { module.exports(); console.log('Current assets: OK'); }

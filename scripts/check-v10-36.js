...
if(!/const C='piste-community-v2074'/.test(sw)||!/app\.js\?v=1074/.test(html)||!/app\.js\?v=1074/.test(sw)||!/v2\.css\?v=2057/.test(html)||!/v2\.css\?v=2057/.test(sw))throw new Error('Cache Terrain incohérent');

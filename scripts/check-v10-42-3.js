...
check('Commandes par rôle : Terminer la piste réservé au Conducteur après le parcours',()=>{
 ...
 vm.createContext(c);for(const name of ['coachingTimingV1045','coachingTimestampV1045','coachingSearchLabelV1045','coachingReadyNoticeV1045','syncCoachingDeferredV1045','coachingPhaseLabel','updateCoachingPhase','updateCoachingWorkflowNotice','applyV1040RoleSurface'])vm.runInContext(source(name),c);

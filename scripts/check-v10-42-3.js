...
check('cache et version applicative',()=>{assert(app.includes("APP_VERSION='10.42.3'"));assert(html.includes('app.js?v=1042-20'));assert(sw.includes('app.js?v=1042-20'));assert(sw.includes('piste-community-v2109'))});
